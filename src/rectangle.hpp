...
public:
	...
	Rectangle(SDL_FRect sdl_frect) :
		x(static_cast<double>(sdl_frect.x)), y(static_cast<double>(sdl_frect.y)), w(static_cast<double>(sdl_frect.w)), h(static_cast<double>(sdl_frect.h)) {}
