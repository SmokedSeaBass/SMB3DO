...
public:
	...
	/// @param source_x Initial x-coordinate of the rect used for rendering the sprite.
	/// Defaults to -1 (will not render).
	/// @param source_y Initial y-coordinate of the rect used for rendering the sprite.
	/// Defaults to -1 (will not render).
	/// @param source_w Initial width of the rect used for rendering the sprite. Defaults
	/// to -1 (will not render).
	/// @param source_h Initial height of the rect used for rendering the sprite. Defaults
	/// to -1 (will not render).
	...
	/// @param frame_gap Size of the gap, in pixels, between each frame of the animation in
	/// the source image. Defaults to 0.
	AnimatedSprite(
		Graphics& graphics,
		const std::string& file_path,
		SDL_Point alpha_pixel,
		SDL_Rect clip,
